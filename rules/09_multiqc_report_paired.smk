rule multiqc_report:
    ...
    input:
        ...
        expand(config['qc_temp'] + date_dir + '{sample_id}_1_fastqc.zip', sample_id=sample_ids),
        expand(config['qc_temp'] + date_dir + '{sample_id}_2_fastqc.zip', sample_id=sample_ids)
    output:
