rule fastq_download_paired_end:
    # Description
    #input:
    output:
    ...
    params:
        ...
        fq1=config['fastq_dir'] + '{sample_id}_1.fastq',
        fq2=config['fastq_dir'] + '{sample_id}_2.fastq',
    ...
    shell:
        ...
        > {log.log}
        pigz -p {params.threads} {params.fq1} {params.fq2}
        '''
