...
rule align_star_paired:
    # Description
    input:
        fq1 = config['temp_fastq'] + '{sample_id}_1_val_1.fq',
        fq2 = config['temp_fastq'] + '{sample_id}_2_val_2.fq',
    ...
    shell:
        ...
        --readFilesIn {input.fq1} {input.fq2} --quantMode GeneCounts \
        2> {log.log}
        mv {params.output_name} {output.bam}
        '''
